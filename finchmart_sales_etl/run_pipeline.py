"""
FinchMart Sales ETL Pipeline Runner
...
def bronze_layer_ingestion(spark):
    """Bronze Layer: Ingest raw CSV files into Delta Lake"""
    print("=" * 80)
    ...
    # Read CSV files as batch (simulating streaming)
...
def gold_layer_aggregation(spark):
    ...
    print("\n5. Optimizing Gold layer tables with Z-Ordering...")
